...
- **Endpoint**：`POST https://app-bu7wnuu44l4x-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bu7wnuu44l4x-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
